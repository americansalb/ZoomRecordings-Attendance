  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Link
          to="/live"
          className="card hover:shadow-lg transition-shadow cursor-pointer border-2 border-green-200"
        >
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-sm text-gray-500">Active sessions & alerts</p>
            </div>
          </div>
        </Link>
        ...
        <Link
          to="/tutor"
          className="card hover:shadow-lg transition-shadow cursor-pointer border-2 border-indigo-200"
        >
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h3 className="text-lg font-medium text-gray-900">Live Tutor</h3>
              <p className="text-sm text-gray-500">In-meeting assistant & approvals</p>
            </div>
          </div>
        </Link>
